...
![Брендбук стартапа «Школа Терапии»](./BrandBook.png)

Брендбук содержит название и слоган, УТП, позиционирование, основной и инверсный варианты логотипа, монограмму `D / T`, типографику, цветовую систему и примеры применения на визитке, баннере и иконке.
